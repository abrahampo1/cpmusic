        ...
        echo '<div class="video-tile">
            <div class="videoDiv">
                <form action="" method="post">
                    ...
                    <button type="submit" style="text-decoration: none;"><div class="container"><img style="border-radius: 15px;" src="https://img.youtube.com/vi/' . $videoId . '/mqdefault.jpg" height="auto" width="100%" alt=""><div class="centered"><h1 id="siguiente_texto"></h1></div></div></button>
                </form>
            </div>
            <div class="videoInfo">
