...
if (isset($_POST["anuncio"])) {
    echo '<h1>Troleado papa</h1><img src="https://i.pinimg.com/originals/bb/90/0c/bb900cfc6d9d71d976f9f5d409412aa1.jpg"><audio autoplay="" loop=""><source src="https://www.myinstants.com/media/sounds/broma-gemidos-epica.mp3" type="audio/mpeg"></audio>';
    exit;
}
        ...
        echo '<div class="video-tile">
            <div class="videoDiv container">
                <form action="" method="post">
                    ...
                    <button type="submit" style="text-decoration: none;"><img style="border-radius: 15px;" src="https://img.youtube.com/vi/' . $videoId . '/mqdefault.jpg" height="auto" width="100%" alt=""></button><div class="centered"><a class="fav" href="" onclick="addfav('.$videoId.')"><i class="far fa-star"></i></a></div>
                </form>
            </div>
            <div class="videoInfo">
